            ...
            <div class="order-health-container">
              ...
              <div class="order-health-chart">
                <svg viewBox="0 0 200 200" class="donut-svg-compact">
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--border-subtle)" stroke-width="25"/>
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--status-success)" stroke-width="25"
                    :stroke-dasharray="`${getCircleSegment(statusData.delivered)} 408`"
                    stroke-dashoffset="0" transform="rotate(-90 100 100)"/>
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--status-info)" stroke-width="25"
                    :stroke-dasharray="`${getCircleSegment(statusData.shipped)} 408`"
                    :stroke-dashoffset="`-${getCircleSegment(statusData.delivered)}`"
                    transform="rotate(-90 100 100)"/>
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--status-warning)" stroke-width="25"
                    ...
                    transform="rotate(-90 100 100)"/>
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--status-danger)" stroke-width="25"
                ...
                <div class="donut-legend-compact">
                  <div class="legend-item-compact"><span class="legend-dot" style="background: var(--status-success)"></span>{{ t('status.delivered') }}</div>
                  <div class="legend-item-compact"><span class="legend-dot" style="background: var(--status-info)"></span>{{ t('status.shipped') }}</div>
                  <div class="legend-item-compact"><span class="legend-dot" style="background: var(--status-warning)"></span>{{ t('status.processing') }}</div>
                  <div class="legend-item-compact"><span class="legend-dot" style="background: var(--status-danger)"></span>{{ t('status.backordered') }}</div>
                </div>
              </div>
            ...
            <table>
              ...
              <tbody>
                ...
                >
                  ...
                  <td @click="showBacklogDetail(item)" style="cursor: pointer;">
                    <span :style="{ color: item.days_delayed > 7 ? 'var(--status-danger)' : 'var(--status-warning)', fontWeight: 600 }">
...
.health-metric-value.metric-good {
  color: var(--status-success);
}

.health-metric-value.metric-warning {
  color: var(--status-warning);
}

.health-metric-value.metric-bad {
